...
/*  Descrever o que faz: 
    Calcula a translação do alfabeto que melhor se adequa com base nas 
    frequências de ocorrência dos caracteres na língua de base.
    Isso é feito tomando como parâmentro o 'fit', que é dado pela fórmula:
    sum((freq[i + SHIFT] - xfreq[i])^2 / xfreq[i]), onde freq é a frequência
    no texto e xfreq a frequência da língua e a soma é em todas letras. 
    O 'SHIFT' é a translação. O valor de 'SHIFT' que apresenta menor soma no
    fit é escolhido como o adequado. 
*/
...
/*  Descrever o que faz: 
    Primeiro, é aplicado o 'fit' ao texto, dividindo-o em "textos em 
    intervalos" e para cada um desse aplica o 'fit'.
    Então é calculado o 'fit' para o texto todo e esse valor retornado  
